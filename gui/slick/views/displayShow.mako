                ...
                <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12 pull-right">
                    <div class="pull-right" id="checkboxControls">
                        <div style="padding-bottom: 5px;">
                            ...
                            <label class="pull-right" for="watched"><span class="watched"><input type="checkbox" id="watched" checked="checked" /> ${_('Watched')}: <b>${epCounts[Overview.WATCHED]}</b></span></label>
